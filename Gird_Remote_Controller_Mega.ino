...
#define RST  A12
#define DC   A14
#define MOSI 32    // An alias
#define SCK  34     //if you use the hardware spi,this pin is no need to set - Wire to pin 13 on a Pro Mini
#define MISO 36    // unused - my SSD1283A is write-only (no read)
...
LCDWIKI_SPI my_lcd(MODEL,CS,DC, MISO, MOSI, RST, SCK, LED); // Tell the lib what pins we are using
